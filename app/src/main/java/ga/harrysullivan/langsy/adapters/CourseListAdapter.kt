...
class CourseListAdapter(inflater: LayoutInflater, parent: ViewGroup, courses: List<Course>) {
    ...
    init {
        courses.forEach { course ->
            run {
                ...
                courseLabel.findViewById<TextView>(R.id.course_label_language).text = CourseList.localFromCode(course.language)
